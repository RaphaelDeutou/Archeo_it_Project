...
<body>
    ...
    <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarTogglerDemo02">
                    <ul class="navbar-nav  ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="dashboard_contact.php">Liste contacts</a>
                        </li>
                        <li class="nav-item  ">
        ...
        <h2 class="text-center">FORMULAIRE DE <span class="marqueur"> CONTACT</span></h2>
                    ...
                    <tbody>
                        <tr>
                            ...
                            if (!$connect) {
                                ...
                                /* ma requete*/
                                $requete = "SELECT id, nom, prenom, email, messages FROM contact";
                                ...
                                while ($row = mysqli_fetch_array($execution)) {
                                    ...
                                    echo " <td >{$email} </td>";
                                    echo " <td >{$messages} </td>";
                                    echo " <td  class='text-center'>  <a href='delete_c.php?delete={$userid}' class='btn btn-danger'> <i class='bi bi-trash'></i> DELETE</a> </td>";
